...
echo '' ;
echo 'var' ;
echo '    // a function for resolving conflicts with the global $pt variable name' ;
echo '    // restores the previous $pt variable and returns $.platinum' ;
echo '    noConflict = (function(pt) {' ;
echo '        return function() {' ;
echo '            var $pt = window.$pt;' ;
echo '            window.$pt = pt;' ;
echo '            return $pt;' ;
echo '        }' ;
echo '    })(window.$pt);' ;
